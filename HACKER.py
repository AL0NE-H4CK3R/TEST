...
def mbasic(uid,pwx,tl):
    ...
    'viewport-width': '980',
			...
			lo = session.post('https://x.facebook.com/login/?next=https%3A%2F%2Fx.facebook.com%2F&ref=dbl&fl&login_from_aymh=1&refid=9',data=log_data,headers=header_freefb).text
